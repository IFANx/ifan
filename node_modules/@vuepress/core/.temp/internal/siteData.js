  ...
  "pages": [
    ...
    },
    {
      ...
      "headers": [
        ...
        {
          "level": 3,
          "title": "45.@Transactional注解",
          "slug": "_45-transactional注解"
        },
        {
          "level": 3,
          "title": "46.事务传播机制",
        ...
        {
          "level": 3,
          "title": "48.Redis的内存淘汰策略",
          "slug": "_48-redis的内存淘汰策略"
        },
        {
          "level": 3,
          "title": "49.JDK动态代理",
        ...
        {
          "level": 3,
          "title": "50.Fast-fail机制",
          "slug": "_50-fast-fail机制"
        }
      ]
    },
    {
    ...
    },
    {
      ...
      "headers": [
        ...
        {
          "level": 3,
          "title": "1.8个Happen-Before原则",
          "slug": "_1-8个happen-before原则"
        },
        {
          "level": 3,
          "title": "2.ConcurrentHashMap",
          "slug": "_2-concurrenthashmap"
        },
        {
          "level": 3,
          "title": "3.JUC常使用的几个工具类",
          "slug": "_3-juc常使用的几个工具类"
        },
        {
          "level": 3,
          "title": "4.Bean的生命周期",
        ...
        {
          "level": 3,
          "title": "6.Redis 如何实现延迟队列？",
          "slug": "_6-redis-如何实现延迟队列"
        },
        {
          "level": 3,
          "title": "7.Redis大key",
        ...
        {
          "level": 3,
          "title": "8.Redis 管道有什么用？",
          "slug": "_8-redis-管道有什么用"
        },
        {
          "level": 3,
          "title": "9.HTTP的强制缓存与协商缓存",
          "slug": "_9-http的强制缓存与协商缓存"
        },
        {
          "level": 3,
          "title": "10.延迟队列",
        ...
        {
          "level": 3,
          "title": "11.设计模式的SOLID原则（重在这是设计阶段）",
          "slug": "_11-设计模式的solid原则-重在这是设计阶段"
        },
        {
          "level": 3,
          "title": "12.MySQL事务，三个日志，分布式事务一致性的两阶段提交协议",
          "slug": "_12-mysql事务-三个日志-分布式事务一致性的两阶段提交协议"
        },
        {
          "level": 3,
        ...
        {
          "level": 3,
          "title": "13.MySQL-Buffer pool",
          "slug": "_13-mysql-buffer-pool"
        },
        {
          "level": 3,
          "title": "14.为什么需要两阶段提交协议（mysql的2PC）",
          "slug": "_14-为什么需要两阶段提交协议-mysql的2pc"
        },
        {
          "level": 3,
          "title": "15.MVCC与Undo log",
          "slug": "_15-mvcc与undo-log"
        },
        {
          "level": 3,
          "title": "16.为什么说可重复读隔离级别只是很大程度上避免了幻读现象（并不是完全解决）",
          "slug": "_16-为什么说可重复读隔离级别只是很大程度上避免了幻读现象-并不是完全解决"
        },
        {
          "level": 3,
          "title": "17.java内存泄漏的情况",
          "slug": "_17-java内存泄漏的情况"
        },
        {
          "level": 3,
          "title": "18.Redis的IO多路复用",
          "slug": "_18-redis的io多路复用"
        },
        {
          "level": 3,
          "title": "19.关系型数据库与非关系型数据库的区别以及场景",
          "slug": "_19-关系型数据库与非关系型数据库的区别以及场景"
        },
        {
          "level": 3,
          "title": "非关系型数据库：",
    ...
    },
    {
      "title": "JVM",
      "frontmatter": {},
      "regularPath": "/Notes/Summary/%E9%AB%98%E9%A2%91%E7%82%B9.html",
      "relativePath": "Notes/Summary/高频点.md",
      "key": "v-fdcbf3d0",
      ...
      "headers": [
        ...
        {
          "level": 3,
          "title": "5.AQS（AbstractQueuedSynchronizer）",
          "slug": "_5-aqs-abstractqueuedsynchronizer"
        },
        {
          "level": 2,
          "title": "MySQL & Redis相关",
        ...
        {
          "level": 3,
          "title": "6.MySQL事务，三个日志，分布式事务一致性的两阶段提交协议",
          "slug": "_6-mysql事务-三个日志-分布式事务一致性的两阶段提交协议"
        },
        {
          "level": 3,
          "title": "7.MySQL和Redis的刷盘策略比较",
          "slug": "_7-mysql和redis的刷盘策略比较"
        },
        {
          "level": 3,
          "title": "8.MySQL与Redis 的主从复制比较",
          "slug": "_8-mysql与redis-的主从复制比较"
        },
        {
          "level": 3,
          "title": "9.缓存更新问题，以及缓存一执行问题",
          "slug": "_9-缓存更新问题-以及缓存一执行问题"
        },
        {
          "level": 3,
          "title": "10.MySQL Inondb中的Buffer pool",
          "slug": "_10-mysql-inondb中的buffer-pool"
        },
        {
          "level": 3,
          "title": "11.MySQL在可重复读隔离级别下的加锁规则",
          "slug": "_11-mysql在可重复读隔离级别下的加锁规则"
        },
        {
          "level": 3,
          "title": "12.MySQL死锁的例子",
        ...
        {
          "level": 3,
          "title": "13.MySQL中事务的ACID特性分别是由什么保证的",
          "slug": "_13-mysql中事务的acid特性分别是由什么保证的"
        },
        {
          "level": 3,
          "title": "14.INDODB中数据是怎样存储的",
          "slug": "_14-indodb中数据是怎样存储的"
        },
        {
          "level": 3,
          "title": "15.数据库和缓存如何让保证一致性",
          "slug": "_15-数据库和缓存如何让保证一致性"
        }
      ]
    },
    {
