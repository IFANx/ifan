...
![img](/images/db/redis/redis-cluster-3.png)
...
![img](/images/db/redis/redis-cluster-4.png)

### [#](#ask-重定向) ASK 重定向

Ask重定向发生于集群伸缩时，集群伸缩会导致槽迁移，当我们去源节点访问时，此时数据已经可能已经迁移到了目标节点，使用Ask重定向来解决此种情况。

![img](/images/db/redis/redis-cluster-5.png)
...
![img](/images/db/redis/redis-cluster-1.png)
...
![img](/images/db/redis/redis-cluster-2.png)
...
![img](/images/db/redis/db-redis-cluster-1.png)
...
![img](/images/db/redis/db-redis-cluster-2.png)
...
![img](/images/db/redis/db-redis-cluster-3.png)
