...
### [#](https://pdai.tech/md/spring/spring-x-framework-aop.html#aop是什么)AOP是什么
...
![spring-framework-aop-4](http://8.130.25.175:8080/img/spring-framework-aop-4.png)
...
![spring-framework-aop-4](http://8.130.25.175:8080/img/spring-framework-aop-5.png)
...
![spring-framework-aop-4](http://8.130.25.175:8080/img/spring-framework-aop-6.png)
...
> Spring AOP的实现方式是动态织入，动态织入的方式是在运行时动态将要增强的代码织入到目标类中，这样往往是通过动态代理技术完成的；**如Java JDK的动态代理(Proxy，底层通过反射实现)或者CGLIB的动态代理(底层通过继承实现)**，Spring AOP采用的就是基于运行时增强的代理技术。所以我们看下如下的两个例子([例子代码在新窗口打开](https://github.com/realpdai/tech-pdai-spring-demos) 中05模块）：
>
> - 基于JDK代理例子
> - 基于Cglib代理例子
...
![img](/images/spring/springframework/spring-framework-aop-7.png)
